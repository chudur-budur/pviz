% function [f, g, x] = gaa(objnum, x)
% 	if nargin == 1
% 		prob.nx = 27;
% 		prob.nf = objnum;
% 		prob.ng = 1;
%         prob.range(1,:)=[0.24,0.48]; 
%         prob.range(2,:)=[7,11];
%         prob.range(3,:)=[0,6];
%         prob.range(4,:)=[5.5,5.968];
%         prob.range(5,:)=[19,25];
%         prob.range(6,:)=[85,110];
%         prob.range(7,:)=[14,20];
%         prob.range(8,:)=[3,3.75];
%         prob.range(9,:)=[0.46,1];
%         prob.range(10,:)=[0.24,0.48];
%         prob.range(11,:)=[7,11];
%         prob.range(12,:)=[0,6];
%         prob.range(13,:)=[5.5,5.968];
%         prob.range(14,:)=[19,25];
%         prob.range(15,:)=[85,110];
%         prob.range(16,:)=[14,20];
%         prob.range(17,:)=[3,3.75];
%         prob.range(18,:)=[0.46,1];
%         prob.range(19,:)=[0.24,0.48];
%         prob.range(20,:)=[7,11];
%         prob.range(21,:)=[0,6];
%         prob.range(22,:)=[5.5,5.968];
%         prob.range(23,:)=[19,25];
%         prob.range(24,:)=[85,110];
%         prob.range(25,:)=[14,20];
%         prob.range(26,:)=[3,3.75];
%         prob.range(27,:)=[0.46,1];
% 		f = prob;
% 	else
% 		[f,g] = gaa_true(x,objnum);
% 	end
% end

% The GAA constraint function, we are using this.
function [g, geq] = gaa_constfunc(x)
		[~, g, ~] = gaa_true(x, 10);
        geq = [];
end

function [f, g, x, cv] = gaa_true(x, objnum)
